...
export type HostThemeKind = 1 | 2 | 3 | 4;
...
function readThemeFlag(value: string | null): boolean | undefined {
  if (!value) {
    return undefined;
  }
...
export function detectDarkMode(fallbackToSystemDark: boolean): boolean {
...
export function readHostThemeKind(value: unknown): HostThemeKind | undefined {
...
export function hostThemeKindToDark(kind: HostThemeKind | undefined): boolean | undefined {
  if (kind === 2) {
    return true;
  }
  if (kind === 1 || kind === 4) {
