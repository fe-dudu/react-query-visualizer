...
import { compareActionOrder, fileImpactForNode, projectKeyForNode } from './layoutNodeMetrics';
import { DEFAULT_NODE_HEIGHT, FILE_ACTION_PROJECT_GAP, resolveVerticalRowGap } from './spacing';
import type { GraphNode, WebviewPayload } from '../model';
