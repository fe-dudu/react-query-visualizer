...
export function RqvFlowNode({ data }: NodeProps) {
  ...
  return (
    <div
      className={cx(
        'h-full min-h-[173px] overflow-hidden rounded-xl border border-transparent p-[11px_11px] shadow-[0_4px_10px_rgba(24,24,27,0.12)] dark:shadow-[0_4px_10px_rgba(0,0,0,0.32)]',
        NODE_SURFACE_CLASS[visualKind],
        nodeData.dim && 'opacity-80',
        nodeData.highlighted &&
          'border-zinc-500 shadow-[0_0_0_1px_rgba(113,113,122,0.3),0_6px_14px_rgba(24,24,27,0.16)] dark:border-zinc-300 dark:shadow-[0_0_0_1px_rgba(212,212,216,0.3),0_6px_14px_rgba(0,0,0,0.42)]',
        nodeData.selected &&
