...
let scanModulePromise: Promise<typeof import('./commands/scan')> | undefined;

function loadScanModule(): Promise<typeof import('./commands/scan')> {
  if (!scanModulePromise) {
    scanModulePromise = import('./commands/scan');
  }
